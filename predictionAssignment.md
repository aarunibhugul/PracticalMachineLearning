...
Aaruni Bhugul [GitHub](https://github.com/aarunibhugul/)  


```
## Run time: 2018-05-09 15:40:34
## R version: R version 3.1.1 (2018-05-09)
```
...
```
![alt text](https://github.com/aarunibhugul/PracticalMachineLearning/blob/master/figures/histGroup1.png)

```r
histGroup(DTrainCS, "[^(fore)]arm")
```

![alt text](https://github.com/aarunibhugul/PracticalMachineLearning/blob/master/figures/histGroup2.png) 

```r
histGroup(DTrainCS, "dumbbell")
```

![alt text](https://github.com/aarunibhugul/PracticalMachineLearning/blob/master/figures/histGroup3.png) 

```r
histGroup(DTrainCS, "forearm")
```

![alt text](https://github.com/aarunibhugul/PracticalMachineLearning/blob/master/figures/histGroup4.png) 
